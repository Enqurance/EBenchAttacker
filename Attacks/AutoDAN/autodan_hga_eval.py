...
if __name__ == '__main__':
    ...
    for i, (g, t) in tqdm(enumerate(dataset), total=len(harmful_data.English[args.start:])):
        ...
        if not os.path.exists('./result/AutoDAN/' + time_str):
            os.makedirs('./result/AutoDAN/' + time_str)
        with open('./result/AutoDAN/' +  time_str + "/" + f'{args.model}_AutoDAN.json', 'w') as json_file:
