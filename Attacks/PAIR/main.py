...
if __name__ == '__main__':
    ...
    parser.add_argument(
        ...
        choices=["LLaMA-2-7B-chat-hf", "GPT-3.5-Turbo-0125", "GPT-4"]
    )
    parser.add_argument(
        "--attack-max-n-tokens",
        type = int,
    ...
    parser.add_argument(
        ...
        choices=["GPT-3.5-Turbo-0125", "GPT-4","no-judge"]
    )
    parser.add_argument(
        "--judge-max-n-tokens",
        type = int,
    ...
    ########### Parameters from EBench ##########
    
    parser.add_argument(
        '--api-use-proxy',
        type=bool,
        default=False, 
        help='This arg. determines whether to use APIs proxy or not'
    )
    
    parser.add_argument(
        '--api-info-path',
        type=str,
        default="./Attacks/assets/API_info.json",
        help='This arg. determines the path for APIs\' information'
    )
    ##################################################
